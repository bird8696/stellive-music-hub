...
CHANNEL_META: list[dict] = [
    ...
    {"handle": "@Sakihanechannel", "member_name": "후야",   "member_name_full": "사키하네 후야", "generation": "1기 EVERYS",   "channel_id": None},
    ...
    {"handle": "@hanako_nana",     "member_name": "나나",   "member_name_full": "하나코 나나",  "generation": "3기 cliché",   "channel_id": None},
...
PLAYLIST_IDS: list[dict] = [
    ...
    # 2기 UNIVERSE
    {"playlist_id": "PLWwhuXFHGLvhgZZb5_rmQEMI1B0ysKJxG",  "member_name": "마시로", "song_type": "cover"},
    {"playlist_id": "PLWwhuXFHGLvgHQY8lryIUP7vf9i8-TJrk",  "member_name": "마시로", "song_type": "original"},
    ...
    {"playlist_id": "PLbIDsfX2JRA0oawGN209gpd_nz9IMvUlb",  "member_name": "타비",   "song_type": "cover"},
    {"playlist_id": "PLbIDsfX2JRA0TXoG69AT8Iu9QEB9lUC2s",  "member_name": "타비",   "song_type": "original"},
    {"playlist_id": "PL-DHk0WpiRNSM5oI19ImJ8sSV65mnGseX",  "member_name": "리제",   "song_type": "cover"},
    {"playlist_id": "PL-DHk0WpiRNSHxQzKx88q2kmJVwlCQCNq",  "member_name": "리제",   "song_type": "original"},
    # 3기 cliché
...
INCLUDE_TITLE_KEYWORDS = ["커버", "Cover", "cover", "오리지널", "Original", "MV", "M/V", "노래", "음악", "OST", "Song", "【歌ってみた】", "(Cover)", "Music Video", "뮤직비디오"]
